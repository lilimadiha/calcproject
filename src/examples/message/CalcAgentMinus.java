 ...
 * @author Lili Madiha
 */
public class CalcAgentMinus extends Agent  {
	...
	addBehaviour(new CyclicBehaviour(this) 
	{
		...
		if (msg != null) 
                {   
                    ...
                    System.out.println("\n[CalcAgentMinus] Message Received");
                    System.out.println("[CalcAgentMinus] Sender Agent   : " + msg.getSender());
                    System.out.println("[CalcAgentMinus] Message content [Base64 string]: " + msgContent);                    
                    ...
                    {
                        System.out.println("\n[CalcAgentMinus] StrToObj conversion error: " + ex.getMessage());
                    }
                    
                    if (calc.getOperation().equals("minus")) {
                        ...
                        System.out.println("[CalcAgentMinus] Calculation result: " + 
                        ...
                        {
                            System.out.println("\n[CalcAgentMinus] ObjToStr conversion error: " + ex.getMessage());
                        }
                        ...
                        System.out.println("\n[CalcAgentMinus] Sending Message!");
                        System.out.println("[CalcAgentMinus] Receiver Agent                 : " + msg.getSender());
                        System.out.println("[CalcAgentMinus] Message content [Base64 string]: " + msg.getContent());
                    }
                ...
                System.out.println("[CalcAgentMinus] CyclicBehaviour Block");
                block();
            }
	});
    }
