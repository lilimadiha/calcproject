 ...
 * @author Lili Madiha
 */
public class CalcAgentMultiply extends Agent {
	...
	addBehaviour(new CyclicBehaviour(this) 
	{
		...
		if (msg != null) 
                {   
                    ...
                    System.out.println("\n[CalcAgentMultiply] Message Received");
                    System.out.println("[CalcAgentMultiply] Sender Agent   : " + msg.getSender());
                    System.out.println("[CalcAgentMultiply] Message content [Base64 string]: " + msgContent);                    
                    ...
                    {
                        System.out.println("\n[CalcAgentMultiply] StrToObj conversion error: " + ex.getMessage());
                    }
                    
                    if (calc.getOperation().equals("multiply")) {
                        ...
                        System.out.println("[CalcAgentMultiply] Calculation result: " + 
                        ...
                        {
                            System.out.println("\n[CalcAgentMultiply] ObjToStr conversion error: " + ex.getMessage());
                        }
                        ...
                        System.out.println("\n[CalcAgentMultiply] Sending Message!");
                        System.out.println("[CalcAgentMultiply] Receiver Agent                 : " + msg.getSender());
                        System.out.println("[CalcAgentMultiply] Message content [Base64 string]: " + msg.getContent());
                    }
                ...
                System.out.println("[CalcAgentMultiply] CyclicBehaviour Block");
                block();
            }
	});
    }
