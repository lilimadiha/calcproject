 ...
 * @author Lili Madiha
 */
public class CalcAgentDivide extends Agent {
	...
	addBehaviour(new CyclicBehaviour(this) 
	{
		...
		if (msg != null) 
                {   
                    ...
                    System.out.println("\n[CalcAgentDivide] Message Received");
                    System.out.println("[CalcAgentDivide] Sender Agent   : " + msg.getSender());
                    System.out.println("[CalcAgentDivide] Message content [Base64 string]: " + msgContent);                    
                    ...
                    {
                        System.out.println("\n[CalcAgentDivide] StrToObj conversion error: " + ex.getMessage());
                    }
                    
                    if (calc.getOperation().equals("divide")) {
                        ...
                        System.out.println("[CalcAgentDivide] Calculation result: " + 
                        ...
                        {
                            System.out.println("\n[CalcAgentDivide] ObjToStr conversion error: " + ex.getMessage());
                        }
                        ...
                        System.out.println("\n[CalcAgentDivide] Sending Message!");
                        System.out.println("[CalcAgentDivide] Receiver Agent                 : " + msg.getSender());
                        System.out.println("[CalcAgentDivide] Message content [Base64 string]: " + msg.getContent());
                    }
                ...
                System.out.println("[CalcAgentDivide] CyclicBehaviour Block");
                block();
            }
	});
    }
